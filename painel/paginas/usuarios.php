...
<!-- Modal Perfil -->
<div class="modal fade" id="modalForm" tabindex="-1" aria-labelledby=
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-6">							
                                ...
                                "email" placeholder="E-mail" required>							
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6">							
								...
								<input type="text" class="form-control" id="telefone" name=
                                "telefone" placeholder="Seu Telefone" required>							
						</div>
					...
					<div class="col-md-12">							
								...
								<input type="text" class="form-control" id="endereco_perfil" 
