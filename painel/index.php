		...
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-6">							
								<label>Email</label>
								<input type="email" class="form-control" id="email_perfil" name="email" placeholder="E-mail" value="<?php echo $email_usuario ?>" required>							
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4">							
								...
								<input type="text" class="form-control" id="telefone_perfil" name="telefone" placeholder="Telefone" value="<?php echo $telefone_usuario ?>" required>							
						</div>
					...
					<div class="row">
                        <div class="col-md-12">							
								...
								<input type="text" class="form-control" id="endereco_perfil" name="nome" placeholder="Endereço" value="<?php echo $endereco_usuario ?>">							
						</div>
